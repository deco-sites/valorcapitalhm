...
export default function Portfolio({
    ...
    return (
        <section className={"bg-[#fff]"}>
            <div className="flex flex-col justify-center max-w-[90%] lg:max-w-[80rem] mx-auto lg:px-[5rem] pb-[100px] items-center">
                <div className="flex flex-col gap-5 mb-[48px] mt-[77px]">
                    <h1 className="text-[20px] font-bold text-black text-center">{smallTitle}</h1>
                    <h1 className="text-[42px] font-bold text-black text-center lg:text-[60px]"
