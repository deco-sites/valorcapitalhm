...
export default function OurTeam(props: OurTeam) {
  ...
  return (
    <section className={`p-2.5 xl:px-10`}>
      <div
        className={`bg-gradient-to-bl from-[#2d4168] to-[#1d283e] rounded py-20 px-5 xl:flex xl:py-36 xl:px-20 xl:gap-8`}
      >
        ...
        <div className={`xl:flex-1 xl:mt-8`}>
          <p
            className={`text-sm text-white mb-5 leading-7 xl:text-2xl xl:font-normal`}
          >
            {description}
          </p>
          <div
          ...
          >
            <a
              className={`bg-[#23324f] px-[36px] py-[20px]  text-xl  text-white font-bold rounded-full xl:hover:text-[#1d283e] xl:hover:bg-[rgb(255,255,255,0)] xl:transition-all xl:duration-300`}
              href={buttonHref}
            >
              {buttonText}
            </a>
